 ...
 */
export function useDeliveries(params?: GetDeliveriesParams, options?: { enabled?: boolean }) {
 ...
 */
export function useDelivery(id: number | string | undefined, options?: { enabled?: boolean }) {
  const { enabled = true } = options || {};
...
export function useUpdateDelivery() {
  ...
  return useMutation({
    mutationFn: ({ id, data }: { id: number | string; data: UpdateDeliveryRequest }) => 
